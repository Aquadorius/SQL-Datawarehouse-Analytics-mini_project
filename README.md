...
bashgit clone https://github.com/yourusername/survey-monkey-pipeline.git
...
sql   FROM 'YOUR_PATH_HERE/edited_survey_monkey_dataset.csv'

Run the setup scripts in order

sql   -- 1. Database and table creation
...
Database Name (Optional - default: survey_monkey)

sql   -- In database_setup.sql
